...
void calibrate(){
  ...
  int upLeftBtn = 3, downRightBtn = 4, confirmBtn = 5;
  int position;

  //setup inputs
  pinMode(upLeftBtn, INPUT_PULLUP);
  pinMode(downRightBtn, INPUT_PULLUP);
  ...
  while(!isRightCalibrated){
     Serial.println("Inside cal loop R");
  ...
  while(!isLeftCalibrated){
     Serial.println("Inside cal loop L");
    if(!digitalRead(upLeftBtn)){
      delay(50);
      position++;
    }else if(!digitalRead(downRightBtn)){
  ...
  while(!isUpCalibrated){
     Serial.println("Inside cal loop U");
    if(!digitalRead(upLeftBtn)){
      delay(50);
      position++;
    }else if(!digitalRead(downRightBtn)){
  ...
  while(!isDownCalibrated){
     Serial.println("Inside cal loop D");
    if(!digitalRead(upLeftBtn)){
      delay(50);
      position++;
    }else if(!digitalRead(downRightBtn)){
